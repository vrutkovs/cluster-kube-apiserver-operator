	...
	certRotator := certrotation.NewCertRotationController(
		...
		certrotation.RotatedSigningCASecret{
			...
			AdditionalAnnotations: certrotation.AdditionalAnnotations{
				...
				AutoRegenerateAfterOfflineExpiry: "https://github.com/openshift/cluster-kube-apiserver-operator/pull/1631,'[sig-builds][Feature:Builds] oc new-app should succeed with an imagestream [apigroup:build.openshift.io] [Skipped:Disconnected] [Suite:openshift/conformance/parallel]'",
			},
