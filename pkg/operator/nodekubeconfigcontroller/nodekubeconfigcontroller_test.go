					...
					Object: &corev1.Secret{
						...
						ObjectMeta: metav1.ObjectMeta{
							...
							Annotations: map[string]string{
								...
								certrotation.AutoRegenerateAfterOfflineExpiryAnnotation: "https://github.com/openshift/cluster-kube-apiserver-operator/pull/1757, 'operator conditions kube-apiserver'",
							},
						},
						Data: map[string][]byte{
